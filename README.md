...
- **Focus Areas:** AI, TF-IDF, backend logic, GUI development, testing & automation
...
- **[TraffIQ AI](https://github.com/ashcacerespagan/traffiq-ai)**  
  Traffic simulation with multi-threaded light logic and live visual controls.

- **[Visual Scene Compiler](https://github.com/ashcacerespagan/visual-scene-compiler)**  
  Mini-compiler that parses and renders user-defined shape syntax.

- **[Anime Trivia Quiz](https://github.com/ashcacerespagan/animetriviaquiz)**  
  Java Swing GUI quiz game with real-time scoring and input handling.

- **More projects available across my repositories!**
